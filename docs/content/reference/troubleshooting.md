...
Most of these come down to network reality or how usacoguide serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

usacoguide rate-limits like any public site. usacoguide already paces
...
Where a surface is gated, usacoguide reads a cookie or token you supply
...
`usacoguide`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what usacoguide actually did

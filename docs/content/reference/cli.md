...
```
usacoguide <command> [arguments] [flags]
```

Run `usacoguide <command> --help` for the full flag list on any command. This
...
per operation you declare in `usacoguide/domain.go`.
